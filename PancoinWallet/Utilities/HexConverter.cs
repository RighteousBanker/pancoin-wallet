...
namespace PancoinWallet.Utilities
{
    public class HexConverter
    {
        public static string ToString(byte[] bytes)  //method from stack overflow
        {
        ...
        public static byte[] ToBytes(string hex) //method from stack overflow
        {
            try
            {
